...
export const ExpeditionSchema = z.object({
	...
	equipment_usd: z.number().int().nullable(),
	crew_usd: z.number().int().nullable(),
	permits_usd: z.number().int().nullable(),
	logistics_usd: z.number().int().nullable(),
...
export const NewExpeditionSchema = z.object({
	...
	equipment_usd: z.number().int().nullable().optional(),
	crew_usd: z.number().int().nullable().optional(),
	permits_usd: z.number().int().nullable().optional(),
	logistics_usd: z.number().int().nullable().optional(),
